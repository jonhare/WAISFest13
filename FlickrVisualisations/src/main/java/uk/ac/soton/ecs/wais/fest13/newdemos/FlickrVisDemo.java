...
public abstract class FlickrVisDemo implements KeyListener {
	protected final static String data = "/Users/jon/Data/data-takensort.csv";

	// protected final static MBFImage img = FullScreenDemo.createImage();
	// protected final static MBFImage img = new MBFImage(1080, 580,
	// ColourSpace.RGB);
	protected final static MBFImage img = new MBFImage(
			...
			GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().height - 20,
			ColourSpace.RGB);
